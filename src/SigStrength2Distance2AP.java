...
public class SigStrength2Distance2AP {
	...
	public static void main(String[] args) {
		...
		{
			SigStrength2Distance2AP sigStrength2Distance2AP = new SigStrength2Distance2AP(mac, 25, 5);
			sigStrength2Distance2AP.generateTrace();
			sigStrength2Distance2AP.measureDistance();
		}

	}
	
	public SigStrength2Distance2AP(MACAddress mac, int offlineSize, int onlineSize)
	{
		...
		try {
			f = new FileOutputStream("SigStrength2DistanceTo" + mac.toString().replaceAll(":", ".") + ".txt", true);
		} catch (IOException e) {
